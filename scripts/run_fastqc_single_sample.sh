...
#SBATCH --output=/data/users/awolfruiz/rna_seq/blood-mice-toxoplasma-2025/logs/output/fastqc_%A_%a.out
#SBATCH --error=/data/users/awolfruiz/rna_seq/blood-mice-toxoplasma-2025/logs/error/fastqc_%A_%a.err 
...
DIR=chmod +x run_fastqc_single_sample.sh"/data/courses/rnaseq_course/toxoplasma_de/reads_Blood/"
